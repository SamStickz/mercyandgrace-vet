...
const MILESTONES = [
  { year: '2015', event: 'Mercy & Grace Veterinary opens its doors on Igbogbo-Ebutte Road.' },
  { year: '2018', event: 'Launched our home visit service — a first in the neighbourhood.' },
  { year: '2020', event: 'Expanded to include a full pet boarding and grooming facility.' },
  { year: '2024', event: 'Reached 250 registered patients and welcomed Dr. Yakub to the team.' },
  { year: '2025', event: 'Dr. Oyekunle joins as our third veterinarian, expanding our capacity.' },
  { year: 'Today', event: 'Over 300 happy patients and counting. Still growing, still caring.' },
]
          ...
          <RevealOnScroll>
            <div className="text-center mb-14">
              ...
              <h2 className="font-serif text-4xl font-light text-white">
                10 years of <em className="italic text-[#c8d5c0]">milestones</em>
              </h2>
            </div>
          </RevealOnScroll>
