        ...
        <div className="max-w-7xl mx-auto">
          <RevealOnScroll>
            ...
            <h1 className="font-serif text-5xl md:text-6xl font-light text-[#1e1e1a] leading-tight mb-4">
              Find <em className="not-italic text-[#4a6e4e]">Us</em>
            </h1>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-start">
          ...
          <RevealOnScroll>
            <div className="space-y-8">
              {/* WhatsApp card */}
              <div className="bg-[#f3f3ef] rounded-2xl p-6 border border-[#c8d5c0]/50">
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-10 h-10 rounded-xl bg-[#25D366] flex items-center justify-center flex-shrink-0">
                    <WhatsAppIcon />
                  </div>
                  <div>
                    <p className="text-sm font-semibold text-[#1e1e1a]">
                      Chat with Dr. Grace
                    </p>
              ...
              {[
                ...
                <div key={label} className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-[11px] font-semibold tracking-[0.12em] uppercase text-[#8a8880] mb-1">
                      {label}
                    </p>
                    {href ? (
                      <a
                        href={href}
                        className="text-[15px] font-medium text-[#1e1e1a] hover:text-[#4a6e4e] transition-colors block"
                      >
                        {value}
                      </a>
                    ) : (
                      <p className="text-[15px] font-medium text-[#1e1e1a]">
                        {value}
                      </p>
                    )}
          ...
          <RevealOnScroll delay={150}>
            <div className="rounded-3xl overflow-hidden border border-[#e8e6e0] shadow-lg min-h-[500px]">
              <iframe
