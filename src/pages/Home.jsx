...
const TESTIMONIALS = [
  {
    quote: 'Dr. Grace and her team are absolutely wonderful. My dog pandee was seriously ill, but they took care of her. I cannot recommend them enough.',
    name: 'Mr A',
    pet: 'Pandee — German Shepherd',
    initial: 'P',
  },
  {
    quote: 'The boarding service is a lifesaver! we took amir to the clinic when my cat was unwell and they handled everything so professionally. Truly exceptional care.',
    name: 'Mr B',
    pet: 'Amir — Persian Cat',
    initial: 'A',
  },
  {
    quote: "My dog was having aural hematoma, he's healed now. The staff treat every animal — big or small — with such tenderness. Mercy & Grace is simply the best.",
    name: 'Mr C',
    pet: 'Bailey — Boerboel',
    initial: 'B',
  },
        ...
        <div className="relative overflow-hidden min-h-[50vh] md:min-h-0 animate-[fadeIn_1.2s_0.2s_ease_both]">
          <div className="absolute inset-0 bg-[#c8d5c0] flex items-center justify-center">
            ...
            <div className="text-center opacity-25">
              ...
              <p className="text-xs mt-2 font-sans text-[#4a6e4e]"> clinic photo</p>
            </div>
          </div>
          <div className="absolute bottom-10 left-6 bg-white rounded-2xl px-5 py-4 shadow-xl flex items-center gap-3 animate-[fadeUp_1s_0.9s_ease_both]">
            ...
            <div>
              ...
              <p className="text-xs text-[#8a8880] mt-0.5">Trusted by 300+ Families</p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <RevealOnScroll>
            ...
            <h2 className="font-serif text-4xl md:text-5xl font-light text-[#1e1e1a] leading-tight mb-6">
              10 years of <em className="not-italic text-[#4a6e4e]">caring for<br />this community</em>
            </h2>
            <p className="text-[15px] font-normal text-[#3a3a36] leading-relaxed mb-5">
              Founded in 2015, Mercy &amp; Grace Veterinary has grown from a small local clinic into a trusted
              practice caring for over 300 pets. Our name reflects everything we stand for — mercy in how
          ...
          <RevealOnScroll>
            <div className="text-center mb-16">
              ...
              <h2 className="font-serif text-4xl md:text-5xl font-light text-white leading-tight">
                Trusted by <em className="not-italic text-[#c8d5c0]">hundreds</em><br />of families
              </h2>
            </div>
          </RevealOnScroll>
