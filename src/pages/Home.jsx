      ...
      <section className="min-h-screen grid md:grid-cols-2 pt-20 overflow-hidden">
        <div className="flex flex-col justify-center px-8 md:px-16 py-20 animate-[fadeUp_1s_0.3s_ease_both]">
          ...
          <div className="flex gap-10 mt-14 pt-10 border-t border-[#d4d2cc]/50">
            {STATS.map(({ num, label }) => (
              <div key={label}>
                <div className="font-serif text-4xl font-light text-[#1e1e1a]">
                  {num}
                </div>
                <div className="text-[12px] text-[#8a8880] tracking-wide mt-1">
                  {label}
                </div>
              </div>
            ))}
        ...
        <div className="relative overflow-hidden min-h-[50vh] md:min-h-0 animate-[fadeIn_1.2s_0.2s_ease_both]">
          <div className="absolute inset-0 bg-[#c8d5c0] flex items-center justify-center">
            ...
            <div className="text-center opacity-25">
              ...
              <p className="text-xs mt-2 font-sans text-[#4a6e4e]">
                {" "}
                clinic photo
              </p>
            </div>
          ...
          <div className="absolute bottom-10 left-6 bg-white rounded-2xl px-5 py-4 shadow-xl flex items-center gap-3 animate-[fadeUp_1s_0.9s_ease_both]">
            <div className="w-11 h-11 rounded-xl bg-[#c8d5c0] flex items-center justify-center flex-shrink-0 text-xl">
              ✅
            </div>
            <div>
      ...
      <div className="bg-[#2d4a30] py-4 overflow-hidden">
        <div className="flex gap-16 animate-[marquee_25s_linear_infinite] w-max">
          {MARQUEE_ITEMS.map((item, i) => (
            <span
              key={i}
              className="flex items-center gap-3 text-[11px] font-medium tracking-[0.14em] uppercase text-[#c8d5c0] whitespace-nowrap"
            >
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14">
              <div>
                ...
                <h2 className="font-serif text-4xl md:text-5xl font-light leading-tight text-[#1e1e1a]">
                  Care for every
                  <br />
                  <em className="not-italic text-[#4a6e4e]">
                    kind of companion
                  </em>
                </h2>
              </div>
            ...
            {SERVICES_PREVIEW.map(({ icon, name, desc }, i) => (
              <RevealOnScroll key={name} delay={i * 80}>
                ...
                >
                  ...
                  <h3 className="font-serif text-xl font-medium text-[#1e1e1a] mb-3">
                    {name}
                  </h3>
                  <p className="text-sm font-light leading-relaxed text-[#8a8880] mb-4">
                    {desc}
                  </p>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-20 items-center">
          ...
          <RevealOnScroll delay={150}>
            ...
            <h2 className="font-serif text-4xl md:text-5xl font-light leading-tight text-[#1e1e1a] mb-6">
              Medicine with
              <br />
              <em className="not-italic text-[#4a6e4e]">heart &amp; purpose</em>
            </h2>
            ...
            <div className="space-y-4 mb-10">
              {[
                ...
                <div
                  key={f}
                  className="flex items-center gap-3 text-sm text-[#3a3a36]"
                >
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14">
              <div>
                ...
                <h2 className="font-serif text-4xl md:text-5xl font-light text-[#1e1e1a] leading-tight">
                  Meet the people who
                  <br />
                  <em className="not-italic text-[#4a6e4e]">love your pets</em>
                </h2>
              </div>
              <Link
                to="/team"
                ...
                >
                  ...
                  <div className="aspect-[4/3] bg-gradient-to-br from-[#c8d5c0] to-[#a3bc9b] flex items-center justify-center relative overflow-hidden">
                    ...
                    <div className="w-20 h-20 rounded-full bg-[#4a6e4e]/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                      <span className="font-serif text-4xl font-light text-[#2d4a30]">
                        {initial}
                      </span>
                    </div>
                    {badge && (
                  ...
                  {/* Info */}
                  <div className="p-7">
                    <p className="text-[11px] font-semibold tracking-[0.12em] uppercase text-[#7a9e7e] mb-1">
                      {role}
                    </p>
                    <h3 className="font-serif text-2xl font-medium text-[#1e1e1a] mb-3">
                      {name}
                    </h3>
                    <p className="text-sm font-light text-[#8a8880] leading-relaxed mb-5">
                      {bio}
                    </p>
          ...
          <RevealOnScroll delay={150}>
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                { num: "300+", label: "Happy Patients", icon: "🐾" },
                { num: "3", label: "Dedicated Vets", icon: "👨‍⚕️" },
                { num: "6", label: "Services Offered", icon: "✅" },
              ].map(({ num, label, icon }) => (
                <div
                  key={label}
                  className="bg-[#f3f3ef] rounded-2xl p-6 border border-[#e8e6e0] hover:border-[#c8d5c0] transition-colors"
                >
                  <div className="text-2xl mb-3">{icon}</div>
                  <div className="font-serif text-3xl font-light text-[#4a6e4e] mb-1">
                    {num}
                  </div>
                  <div className="text-xs font-semibold tracking-[0.1em] uppercase text-[#3a3a36]">
                    {label}
                  </div>
                </div>
              ))}
          ...
          <RevealOnScroll>
            <div className="text-center mb-16">
              <div className="flex items-center justify-center gap-3 text-[#c8d5c0] text-[11px] font-medium tracking-[0.18em] uppercase mb-4">
                <span className="w-6 h-px bg-[#c8d5c0]" /> Client Stories{" "}
                <span className="w-6 h-px bg-[#c8d5c0]" />
              </div>
              <h2 className="font-serif text-4xl md:text-5xl font-light text-white leading-tight">
                Trusted by{" "}
                <em className="not-italic text-[#c8d5c0]">hundreds</em>
                <br />
                of families
              </h2>
            </div>
                ...
                <div className="bg-white/5 border border-white/10 rounded-2xl p-10 hover:bg-white/10 transition-colors duration-300 h-full flex flex-col">
                  <div className="flex gap-1 mb-5">
                    {[...Array(5)].map((_, j) => (
                      <svg
                        key={j}
                        className="w-3.5 h-3.5 fill-[#B89A5E]"
                        viewBox="0 0 24 24"
                      >
                  ...
                  <p className="font-serif text-lg font-light italic leading-relaxed text-white/90 flex-1 mb-8">
                    "{quote}"
                  </p>
      ...
      <section className="bg-[#ede9e0] py-32 px-6 text-center">
        <RevealOnScroll>
          <div className="flex items-center justify-center gap-3 text-[#7a9e7e] text-[11px] font-medium tracking-[0.18em] uppercase mb-5">
            <span className="w-6 h-px bg-[#7a9e7e]" /> Ready to Begin?{" "}
            <span className="w-6 h-px bg-[#7a9e7e]" />
          </div>
          <h2 className="font-serif text-4xl md:text-5xl font-light text-[#1e1e1a] mb-5 leading-tight">
            Give your pet the care
            <br />
            <em className="not-italic text-[#4a6e4e]">they truly deserve</em>
          </h2>
